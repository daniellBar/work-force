      ...
      <div className="employee-preview-container">
        <div className="employee-preview">
          ...
          <div className="col1">
            ...
            <div className="position light">
              {this.modifyLongText(employee.position)}
            </div>
            <div className="position light">
              {this.modifyLongText(employee.mail)}
            </div>
          </div>
          <div className="col2">
            <div className="sal bold">
          ...
          <div className="col3">
            <div className="seniority bold">
              {this.handleSeniorityDisplay({
          ...
          <div className="col4">
            <div
              ...
              onClick={() => this.onClickEditBtn(employee)}
            >
              <EditIcon />
            </div>
            ...
            <div
              ...
              onClick={(ev) => this.onDelete(ev, employee._id)}
            >
              <DeleteForeverIcon />
            </div>
          </div>
          <div className="col5">
            <div
              className="btn collapse-accordion-btn"
              onClick={this.onToggleExpend}
            >
              {!isCollapsed && (
                <ArrowDropDownIcon fontSize="large" htmlColor="#ffffff" />
              )}
              {isCollapsed && (
                <ArrowDropUpIcon fontSize="large" htmlColor="#ffffff" />
              )}
            </div>
          </div>
        </div>
