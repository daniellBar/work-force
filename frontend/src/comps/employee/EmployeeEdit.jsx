...
const emptyProfileImg =
  "https://res.cloudinary.com/dcnijwmki/image/upload/v1614373372/general/guest_it6pn4_p62hcu.jpg";
      ...
      <section className="edit-container">
        <form className="edit-form" onSubmit={this.onClickSubmit}>
              ...
              <div className="edit-profile-pic">
                <img
                  className={`profile-img ${
                    employee.imgUrl ? "edit-img" : "empty-img"
                  }`}
                  src={employee.imgUrl || emptyProfileImg}
                  alt="profile-img"
                />
                <div
                  className={`btn ${
                    employee.imgUrl ? "add" : "edit"
                  }-profile-img-btn`}
                >
          ...
          <div className="form-btns">
            <div className="btn save-btn" onClick={this.onClickSubmit}>
              Save
            </div>
            <div className="btn cancel-btn" onClick={this.onCancelEdit}>
              Cancel
            </div>
          </div>
        </form>
        {employee._id && (
          <div className="edit-prev-next-btns">
            <ArrowBackIcon
              className="btn btn-prev"
              onClick={() => this.moveToPrevNextEmployee(employee.prevEmployee)}
              fontSize="large"
            />
            <ArrowForwardIcon
              className="btn btn-next"
              onClick={() => this.moveToPrevNextEmployee(employee.nextEmployee)}
              fontSize="large"
            />
          </div>
        )}
...
export const EmployeeEdit = connect(
  mapStateToProps,
  mapDispatchToProps
)(_EmployeeEdit);
