      ...
      <section className="employee-side-navbar">
        ...
        >
          <img
            ...
            src={require("../../assets/icons/employees.svg")}
            alt=""
          />
              ...
              return (
                <div
                  className={`btn group-btn ${
                    activeGroupFilter === groupName ? "active" : ""
                  }`}
                  onClick={() => this.onClick(groupName)}
                  key={idx}
                >
                  <img
                    className="group-icon"
                    src={require(`../../assets/icons/${groupName}.svg`)}
                    alt=""
                  />
...
export const EmployeeSideNavBar = connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(_EmployeeSideNavBar));
