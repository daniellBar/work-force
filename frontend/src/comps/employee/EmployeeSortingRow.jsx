      ...
      <section className="employee-sorting-row flex">
        ...
        <div className="sort-col1 name-sort flex">
          ...
          <div className="sort-btns flex">
            <ArrowUpwardIcon
              onClick={() => this.onClick({ by: "name", direction: "up" })}
              fontSize="small"
              htmlColor={activeSort === "name-up" ? "#0ec9ae" : ""}
            />
            <ArrowDownwardIcon
              onClick={() => this.onClick({ by: "name", direction: "down" })}
              fontSize="small"
              htmlColor={activeSort === "name-down" ? "#0ec9ae" : ""}
            />
          </div>
        </div>
        <div className="sort-col2 salary-sort flex">
          ...
          <div className="sort-btns flex">
            <ArrowUpwardIcon
              onClick={() => this.onClick({ by: "salary", direction: "up" })}
              fontSize="small"
              htmlColor={activeSort === "salary-up" ? "#0ec9ae" : ""}
            />
            <ArrowDownwardIcon
              onClick={() => this.onClick({ by: "salary", direction: "down" })}
              fontSize="small"
              htmlColor={activeSort === "salary-down" ? "#0ec9ae" : ""}
            />
          </div>
        </div>
        <div className="sort-col3 seniority-sort flex">
          ...
          <div className="sort-btns flex">
            <ArrowUpwardIcon
              onClick={() => this.onClick({ by: "seniority", direction: "up" })}
              fontSize="small"
              htmlColor={activeSort === "seniority-up" ? "#0ec9ae" : ""}
            />
            <ArrowDownwardIcon
              onClick={() =>
                this.onClick({ by: "seniority", direction: "down" })
              }
              fontSize="small"
              htmlColor={activeSort === "seniority-down" ? "#0ec9ae" : ""}
            />
          </div>
        </div>
